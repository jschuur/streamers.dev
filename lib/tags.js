...
// Create several lists of tags/keywords, one for full title subsrting matches,
// two for fragments (white space separated words) based on regexps and regular string matcheas
...
export function findTags(str) {
  ...
  // ...then match those against any regular expressions for a tag...
  ...
  // ...now look for normal string matches for all the possible keywords...
