...
import { MAX_STATUS_AGE_SECONDS, TWITCH_USER_FIELDS, STATUS_UPDATE_FIELDS } from '../lib/config.js';
...
export async function updateStatuses({ users, updateAll }) {
...
export async function getUserInfoFromTwitch({
  ...
  await updateStatuses({ users, updateAll });
